...
<div style="margin-left:20%; margin-top:10px" >
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10" style="width:50%">
      <input type="text" class="form-control" id="username" placeholder="这里写用户名" name="user_name">
    </div>
  </div>
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">密码</label>
    <div class="col-sm-10" style="width:50%">
      <input type="password" class="form-control" id="passwords" placeholder="我们不会看你的密码的~" name="user_password">
    </div>
  </div>
  <br/>
  <br/>
...
<div>
  <div class="form-group" style="margin-left:8%">
    <div class="col-sm-offset-2 col-sm-10">
      <button type="button" class="btn btn-primary" style="margin-right:5%" onclick="login_check()">登陆</button>
...
<script type="text/javascript">
	function login_check(){
		...
		window.location.href="Login_check.jsp?txtname="+document.user_info.user_name.value+"&txtpassword="+document.user_info.user_password.value;
	}
</script>
</body>
</html>